...
/**
 * Send email to single recipient or multiple recipients
 */
...
/**
 * Send notification to all newsletter subscribers about new blog post
 */
export async function notifySubscribersNewBlog(blogData: {
  title: string
  excerpt: string
  image?: string
  url?: string
  ...
  const blogUrl = blogData.url || `${process.env.NEXT_PUBLIC_SITE_URL || 'https://riseforimpact.org'}/blog`
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="padding: 30px; background: #F9FAFB;">
        ...
        <p style="color: #6B7280; font-size: 14px; margin: 0 0 20px 0;">
          By ${blogData.author} • ${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
        </p>
      ...
      <div style="background: #1F2937; padding: 30px; text-align: center;">
        ...
        <p style="color: #9CA3AF; margin: 0; font-size: 12px;">
          <a href="${process.env.NEXT_PUBLIC_SITE_URL}/unsubscribe" style="color: #22C55E; text-decoration: none;">Unsubscribe</a> • 
          <a href="${process.env.NEXT_PUBLIC_SITE_URL}" style="color: #22C55E; text-decoration: none;">Visit Website</a>
        </p>
 ...
 */
export async function notifyApplicationApproved(applicationData: {
  name: string
  email: string
  type: string
}) {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="padding: 40px; background: white;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${process.env.NEXT_PUBLIC_SITE_URL}/programs" 
             style="display: inline-block; 
                    background: linear-gradient(to right, #22C55E, #10b981); 
                    color: white; 
                    padding: 15px 40px; 
...
/**
 * Send notification when a volunteer application is approved
 */
export async function notifyVolunteerApproved(volunteerData: {
  fullName: string
  email: string
  role: string
}) {
...
/**
 * Send instant confirmation when application is received
 */
export async function notifyApplicationReceived(applicationData: {
  name: string
  email: string
  type: string
  isDonation?: boolean
  ...
  const subject = isDonation 
    ...
    : '✅ Application Received - Rise for Impact'
  ...
  const html = isDonation
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="padding: 40px; background: white;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://riseforimpact.org'}/programs" 
             style="display: inline-block; 
...
/**
 * Send notification to admin when new application/volunteer is submitted
 */
export async function notifyAdminNewSubmission({
  ...
  type: 'application' | 'volunteer' | 'donation'
  name: string
  email: string
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background: linear-gradient(to right, ${
        type === 'donation' ? '#EC4899, #BE185D' : 
        type === 'volunteer' ? '#8B5CF6, #7C3AED' : 
        '#3B82F6, #1D4ED8'
        ...
        <h1 style="color: white; margin: 0; font-size: 28px;">New ${
      ...
      <div style="padding: 40px; background: white;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/admin/${
            type === 'volunteer' ? 'volunteers' : 'applications'
          }" 
             style="display: inline-block; 
      ...
      <div style="background: #1F2937; padding: 30px; text-align: center;">
        <p style="color: #9CA3AF; margin: 0; font-size: 14px;">
          ...
          <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/admin/dashboard" style="color: #22C55E; text-decoration: none;">Go to Dashboard</a>
        </p>
      </div>
    </div>
  `
...
/**
 * Send notification to all subscribers when new opportunity is posted
 */
export async function notifySubscribersNewOpportunity(opportunityData: {
  title: string
  description: string
