...
async function GET() {
    try {
        const blogs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].blogPost.findMany({
            orderBy: {
                date: 'desc'
            }
        });
...
async function POST(request) {
    try {
        ...
        const blogPost = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].blogPost.create({
            data: body
        });
        // Send notification to all newsletter subscribers
        // This runs in the background and doesn't block the response
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2d$notifications$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifySubscribersNewBlog"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a99950b8._.js.map