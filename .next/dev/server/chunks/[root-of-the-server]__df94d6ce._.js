...
const newsletterSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
async function POST(request) {
    ...
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].newsletterSubscriber.findUnique({
            where: {
                email
            }
        });
        ...
        // Add to database
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].newsletterSubscriber.create({
            data: {
                email
            }
        });
...
async function GET() {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(subscribers, {
            status: 200
        });
    } catch (error) {
...
async function PATCH(request) {
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].newsletterSubscriber.update({
            where: {
                id: parseInt(id)
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df94d6ce._.js.map