...
async function POST(request) {
    try {
        ...
        const application = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.create({
            data: {
                name: body.name,
                email: body.email,
...
async function GET() {
    try {
        const applications = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.findMany({
            orderBy: {
                createdAt: 'desc'
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b29b07fd._.js.map